A=int(input("How big would you like the flag to be? Enter a good number from 50 - 650:")); D= round(.76*A); B,C,E,F,G,H,K,L,x=(1.9*A),(7/13)*A,(0.054*A),(0.054*A),(0.063*A),(0.063*A),(0.0616*A),round((1/13)*A),D+(A/10)
...
#
#
# for z_offset in range(round(H*3),D,round(H*2)):arcade.draw_text("*",z_offset-(A/10),D+(A/20),(255,255,255),H*1.5)
# for z_offset in range(round(H*3),D,round(H*2)):arcade.draw_text("*",z_offset-(A/10),D-(A/20),(255,255,255),H*1.5)
# for z_offset in range(round(H*3),D,round(H*2)):arcade.draw_text("*",z_offset-(A/10),D-3*(A/20),(255,255,255),H*1.5)
# for z_offset in range(round(H*3),D,round(H*2,)):arcade.draw_text("*",z_offset-(A/10),D-5*(A/20),(255,255,255),H*1.5)
